...
<head>
    ...
    <style>
        *, *::before, *::after {
        ...
        .step-dot.done   { background: rgba(16,185,129,.4); }
        ...
        .error-box i  { font-size: 32px; color: #ef4444; margin-bottom: 12px; display: block; }
        .error-box h3 { color: #fff; font-size: 15px; margin-bottom: 6px; }
        .error-box p  { color: rgba(255,255,255,.5); font-size: 12.5px; }
    </style>
</head>
<body>
