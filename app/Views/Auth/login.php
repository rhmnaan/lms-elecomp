    ...
    <style>
        ...
        *::after {
        ...
        .bg-canvas::before {
            ...
            inset: 0;
            background-image:
                radial-gradient(circle at 20% 80%, rgba(3, 170, 222, 0.18) 0%, transparent 50%),
                radial-gradient(circle at 80% 20%, rgba(0, 229, 192, 0.12) 0%, transparent 45%),
                radial-gradient(circle at 50% 50%, rgba(13, 38, 86, 0.6) 0%, transparent 70%);
        }
        ...
        .particle {
            ...
            width: 2px;
            height: 2px;
            background: rgba(56, 200, 245, 0.7);
            border-radius: 50%;
        ...
        .badge-top {
            ...
            align-items: center;
            gap: 8px;
            background: rgba(3, 170, 222, 0.12);
            border: 1px solid rgba(3, 170, 222, 0.3);
            border-radius: 100px;
            padding: 6px 14px;
            font-size: 12px;
            font-weight: 500;
        ...
        .pill:hover {
            background: rgba(3, 170, 222, 0.1);
            border-color: rgba(3, 170, 222, 0.3);
            color: var(--white);
        }
        ...
        .modal-card {
            ...
            animation: modalPop .4s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
        ...
        .btn-m-primary {
            background: linear-gradient(135deg, var(--blue-sky), var(--blue-mid));
            color: #fff;
            box-shadow: 0 4px 16px rgba(3, 170, 222, 0.3);
        }
...
<body>
    ...
    <div class="page-wrap">
        <div class="left-panel">
            ...
            <p class="hero-sub">
                Akses materi, tugas, dan evaluasi kapan saja. Wujudkan potensi terbaik Anda bersama Elecomp.
            </p>
        ...
        <div class="card-wrap">
            <div class="card-inner">
                ...
                <div class="card-footer-note">
                    Lupa password? Hubungi <a href="/cdn-cgi/l/email-protection#95f4f1f8fcfbd5f0f9f0f6faf8e5bbe6f6fdbbfcf1"><span class="__cf_email__" data-cfemail="38595c555156785d545d5b575548164b5b5016515c">[email&#160;protected]</span></a><br>
    ...
    <script>
        ...
        getFP(); // pastikan cookie sudah ada sebelum login

        // ── CSRF Token Helper ──
        // CI4 menyimpan CSRF token di cookie 'csrf_cookie_name' (default: 'csrf_test_name')
        // Ambil dan kirim via header X-CSRF-TOKEN agar POST fetch tidak ditolak filter CI4
        ...
        // ── Modal Action ──
        // Menyimpan email & pass sementara untuk dipakai saat modal dikonfirmasi
        let _pendingEmail = '';
        let _pendingPass = '';
        ...
        /**
         * Dipanggil dari tombol di dalam modal konflik sesi.
         * @param {'keep'|'other'} action
         *   'keep'  → tetap login di perangkat ini (logout tab/browser lain via SSE)
         *   'other' → idem, tapi dari perspektif user yang ingin "logout perangkat lain"
         */
