    ...
    <div class="wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <!-- Manajemen Kelas (submenu) -->
                <li class="has-sub <?php echo $isKelas ? 'open' : '' ?>">
                ...
                <!-- Voucher -->
                <li <?php echo str_starts_with(uri_string(), 'dashboard/pengajar/voucher') ? 'class="active"' : '' ?>>
                    <a href="<?php echo base_url('dashboard/pengajar/voucher') ?>">
