...
<div class="ap-wrap">
    ...
    <div class="ap-grid" id="apGrid">
        <?php foreach ($aplikasi as $i => $app):
            ...
            $aosDelay  = 150 + ($i * 70);
        ?>
        <a class="ap-card" href="<?= esc($app['link_aplikasi']) ?>" target="_blank" rel="noopener noreferrer"
            data-name="<?= strtolower(esc($app['nama_aplikasi'])) ?>" data-aos="zoom-in-up" data-aos-duration="500"
