            ...
            <div class="content-section">
                ...
                <div class="file-preview locked">
                    ...
                    <div class="file-info">
                        ...
                        <p>Materi <?= $currentFileLabel ?> terkunci. Selesaikan Pre Test terlebih dahulu untuk membuka
                            materi.</p>
                    </div>
                ...
                <div class="file-preview">
                    ...
                    <div style="display:flex;gap:8px;flex-shrink:0;">
                        ...
                        <div id="docViewerModal"
                            ...
                            <div
                                style="background:#fff;border-radius:16px;width:90%;max-width:1100px;height:88vh;overflow:hidden;display:flex;flex-direction:column;">
                                <div
                                    style="display:flex;align-items:center;justify-content:space-between;padding:14px 20px;border-bottom:1px solid #e5e7eb;">
                                    <span
                                        style="font-weight:700;font-size:14px;"><?= esc($currentMateri['judul_materi']) ?></span>
                                    <button onclick="closeDocViewer()"
                                        style="background:#fee2e2;color:#ef4444;border:none;border-radius:8px;width:32px;height:32px;cursor:pointer;font-size:16px;">✕</button>
                                </div>
                                ...
                                <div id="docViewerLoading"
                                    style="display:none;position:absolute;inset:0;background:rgba(255,255,255,.8);align-items:center;justify-content:center;font-size:14px;color:#6b7280;">
                                    ⏳ Memuat dokumen...
                                </div>
                            </div>
                        </div>
